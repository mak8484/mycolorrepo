...
//  Matchee
//
//  Created by Marco on 24/6/2562 BE.
...
public struct MC {
    ...
    public static let MatcheeRedColor =  #colorLiteral(red: 0.8509803922, green: 0.5647058824, blue: 0.5254901961, alpha: 1)
    public static let MatcheeGreenColor = #colorLiteral(red: 0.5215686275, green: 0.8392156863, blue: 0.6588235294, alpha: 1)
}
